<template>
  <div>
    <!--<div class="top">
      <div class="topCont">
        <div class="topleft">
          <span>天行者留学  SKYWALKER YOUR DREAM MAKER！</span>
        </div>
        <div class="topright">
          <router-link  class="c_login" to="/login" tag="a">登录</router-link><router-link class="c_register" to="/login" tag="a">注册</router-link>
        </div>
      </div>
    </div>-->
   <!-- <div class="ctop">
